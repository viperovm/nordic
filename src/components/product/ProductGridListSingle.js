          ...
          <div className="product-img">
            <Link to={process.env.PUBLIC_URL + "/product/" + product.id}>
              <img
                ...
                alt=""
              />
              {product?.goods_gallery?.length > 1 ? (<img
                  className="hover-img"
                  src={product?.goods_gallery.length ? product?.goods_gallery.length > 1 ? product?.goods_gallery[1].image : '' : ''}
                  alt=""
                />) : ("")}
            </Link>
            ...
            <div className="product-action">
              ...
              <div className="pro-same-action pro-cart">
                ...
                >
                  ...
                  {cartItem !== undefined && cartItem.quantity > 0 ? "Добавлено" : "В корзину"}
                </button>}
              </div>
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-md-7 col-sm-6">
              <div className="shop-list-content">
                ...
                {product.rating && product.rating > 0 ? (<div className="rating-review">
