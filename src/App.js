...
const Temporary = lazy(() => import("./pages/Temporary/index"));
          ...
          <ScrollToTop>
            ...
            >
              <Switch>
                ...
                <Route
                  exact
                  path={process.env.PUBLIC_URL + "/temp" + "/"}
                  component={HomeFashionThree}
                />

                {/* Shop pages */}
                <Route
                  path={process.env.PUBLIC_URL + "/temp" + "/shop-grid-standard"}
                ...
                {/* Shop product pages */}
                <Route
                  path={process.env.PUBLIC_URL + "/temp" + "/product/:id"}
                  render={(routeProps) => (
                ...
                <Route
                  path={process.env.PUBLIC_URL + "/temp" + "/not-found"}
                  component={NotFound}
                />
